...
func (s *PersonFieldsService) listInner(ctx context.Context, start int) (*PersonFieldsResponse, *Response, error) {
	req, err := s.client.NewRequest(http.MethodGet, "/personFields", PaginationOpts(start), nil)
	if err != nil {
		return nil, nil, err
	}
