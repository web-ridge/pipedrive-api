...
func (s *DealService) listInner(ctx context.Context, start int) (*DealsResponse, *Response, error) {
	req, err := s.client.NewRequest(http.MethodGet, "/deals", PaginationOpts(start), nil)
	if err != nil {
		return nil, nil, err
	}
