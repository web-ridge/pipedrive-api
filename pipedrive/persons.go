...
func (s *PersonsService) listInner(ctx context.Context, start int) (*PersonsRespose, *Response, error) {
	req, err := s.client.NewRequest(http.MethodGet, "/persons", PaginationOpts(start), nil)
	if err != nil {
		return nil, nil, err
	}
