...
func (s *DealFieldsService) listInner(ctx context.Context, start int) (*DealFieldsResponse, *Response, error) {
	req, err := s.client.NewRequest(http.MethodGet, "/dealFields", PaginationOpts(start), nil)
	if err != nil {
		return nil, nil, err
	}
